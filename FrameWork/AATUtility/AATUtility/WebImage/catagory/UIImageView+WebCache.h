...
/**
 * Integrates AATWebImage async downloading and caching of remote images with UIImageView.
 *
 * Usage with a UITableViewCell sub-class:
 *
 * @code

#import <AATWebImage/UIImageView+WebCache.h>
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    // Here we use the provided aat_setImageWithURL: method to load the web image
    // Ensure you use a placeholder image otherwise cells will be initialized with no image
    [cell.imageView aat_setImageWithURL:[NSURL URLWithString:@"http://example.com/image.jpg"]
 ...
 */
- (void)aat_setImageWithURL:(nullable NSURL *)url NS_REFINED_FOR_SWIFT;
