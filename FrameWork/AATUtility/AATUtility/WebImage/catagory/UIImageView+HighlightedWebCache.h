...
/**
 * Integrates AATWebImage async downloading and caching of remote images with UIImageView for highlighted state.
 */
 ...
 */
- (void)aat_setHighlightedImageWithURL:(nullable NSURL *)url NS_REFINED_FOR_SWIFT;
...
- (void)aat_setHighlightedImageWithURL:(nullable NSURL *)url
                              options:(AATWebImageOptions)options NS_REFINED_FOR_SWIFT;
 ...
 */
- (void)aat_setHighlightedImageWithURL:(nullable NSURL *)url
                            completed:(nullable AATExternalCompletionBlock)completedBlock NS_REFINED_FOR_SWIFT;
